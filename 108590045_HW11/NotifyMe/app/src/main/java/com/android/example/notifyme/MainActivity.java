...
public class MainActivity extends AppCompatActivity {
    ...
    public void updateNotification() {
        ...
        notifyBuilder.setStyle(new NotificationCompat.InboxStyle().addLine("Here is the First one").addLine("This is the second one").addLine("yay last one").setSummaryText("+3 more"));
