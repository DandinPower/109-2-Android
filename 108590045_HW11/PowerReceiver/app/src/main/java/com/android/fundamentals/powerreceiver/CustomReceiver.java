...
public class CustomReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Integer ranint = intent.getIntExtra("randint",0);
        Double d= new Double(ranint);//first way
        d = Math.pow(d,2);
        Integer Int = d.intValue();
        if (intentAction != null) {
            ...
            switch (intentAction){
                ...
                case ACTION_CUSTOM_BROADCAST:
                    ...
                    toastMessage += "\n";
                    toastMessage += "Square Of the Random number: ";
                    toastMessage += Int.toString();
                    break;
            }
