...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mScore1 = mPreferences.getInt("score1", 0);
        mScore2 = mPreferences.getInt("score2", 0);
    ...
    protected void onPause(){
        ...
        preferencesEditor.putInt("score1", mScore1);
        preferencesEditor.putInt("score2", mScore2);
